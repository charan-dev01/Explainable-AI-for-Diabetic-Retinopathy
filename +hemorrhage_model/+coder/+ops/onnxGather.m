...
% Copyright 2024 The MathWorks, Inc.
    ...
    X          = hemorrhage_model.coder.ops.extractIfDlarray(X_);
    ONNXIdx    = hemorrhage_model.coder.ops.extractIfDlarray(ONNXIdx_);
    ONNXAxis   = hemorrhage_model.coder.ops.extractIfDlarray(ONNXAxis_);
    numDimsX   = hemorrhage_model.coder.ops.extractIfDlarray(numDimsX_);
    numDimsIdx = hemorrhage_model.coder.ops.extractIfDlarray(numDimsIdx_);
