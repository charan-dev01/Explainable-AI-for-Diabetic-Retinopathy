...
Starts = hemorrhage_model.coder.ops.extractIfDlarray(Starts_);
Ends = hemorrhage_model.coder.ops.extractIfDlarray(Ends_);
Axes_ = hemorrhage_model.coder.ops.extractIfDlarray(Axes__);
Steps_ = hemorrhage_model.coder.ops.extractIfDlarray(Steps__);
