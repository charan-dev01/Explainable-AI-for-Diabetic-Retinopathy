...
Starts = microaneurysm_model.coder.ops.extractIfDlarray(Starts_);
Ends = microaneurysm_model.coder.ops.extractIfDlarray(Ends_);
Axes_ = microaneurysm_model.coder.ops.extractIfDlarray(Axes__);
Steps_ = microaneurysm_model.coder.ops.extractIfDlarray(Steps__);
