...
% Copyright 2024 The MathWorks, Inc.
    ...
    X          = microaneurysm_model.coder.ops.extractIfDlarray(X_);
    ONNXIdx    = microaneurysm_model.coder.ops.extractIfDlarray(ONNXIdx_);
    ONNXAxis   = microaneurysm_model.coder.ops.extractIfDlarray(ONNXAxis_);
    numDimsX   = microaneurysm_model.coder.ops.extractIfDlarray(numDimsX_);
    numDimsIdx = microaneurysm_model.coder.ops.extractIfDlarray(numDimsIdx_);
