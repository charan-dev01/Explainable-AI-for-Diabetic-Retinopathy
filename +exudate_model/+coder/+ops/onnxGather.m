...
% Copyright 2024 The MathWorks, Inc.
    ...
    X          = exudate_model.coder.ops.extractIfDlarray(X_);
    ONNXIdx    = exudate_model.coder.ops.extractIfDlarray(ONNXIdx_);
    ONNXAxis   = exudate_model.coder.ops.extractIfDlarray(ONNXAxis_);
    numDimsX   = exudate_model.coder.ops.extractIfDlarray(numDimsX_);
    numDimsIdx = exudate_model.coder.ops.extractIfDlarray(numDimsIdx_);
