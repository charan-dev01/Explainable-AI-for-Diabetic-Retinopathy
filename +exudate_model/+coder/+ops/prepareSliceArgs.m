...
Starts = exudate_model.coder.ops.extractIfDlarray(Starts_);
Ends = exudate_model.coder.ops.extractIfDlarray(Ends_);
Axes_ = exudate_model.coder.ops.extractIfDlarray(Axes__);
Steps_ = exudate_model.coder.ops.extractIfDlarray(Steps__);
